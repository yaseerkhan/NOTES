...
` xfreerdp /v:10.0.0.0 /cert:ignore /u:user`(user ”Administrator” can be default) `/p:password `(password optional, we can skip this flag)
...
## Network Scanning
### NMAP    
For a thorough scan of single host: `$ nmap -A -p- -v {ip} `  
